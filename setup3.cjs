...
// Create db/index.ts (Dexie.js config)
const dbContent = `import Dexie, { Table } from "dexie";
...
fs.writeFileSync("C:/Workspace/wos/src/db/index.ts", dbContent);
console.log("Created db/index.ts");
